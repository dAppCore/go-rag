...
func TestChunk_Category_Good(t *core.T) {
...
func TestChunk_Category_Bad(t *core.T) {
	category := Category("")
...
func TestChunk_Category_Ugly(t *core.T) {
...
func TestChunk_ChunkID_Good(t *core.T) {
...
func TestChunk_ChunkID_Bad(t *core.T) {
	id := ChunkID("docs/guide.md", 1, "Go uses goroutines.")
...
func TestChunk_ChunkID_Ugly(t *core.T) {
...
func TestChunk_ChunkMarkdown_Good(t *core.T) {
...
func TestChunk_ChunkMarkdown_Bad(t *core.T) {
	chunks := ChunkMarkdown("", DefaultChunkConfig())
...
func TestChunk_ChunkMarkdown_Ugly(t *core.T) {
...
func TestChunk_ChunkMarkdownSeq_Good(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkMarkdownSeq_Bad(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkMarkdownSeq_Ugly(t *core.T) {
	count := 0
...
func TestChunk_ChunkBySentencesSeq_Good(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkBySentencesSeq_Bad(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkBySentencesSeq_Ugly(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkByParagraphsSeq_Good(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkByParagraphsSeq_Bad(t *core.T) {
	var chunks []Chunk
...
func TestChunk_ChunkByParagraphsSeq_Ugly(t *core.T) {
	var chunks []Chunk
...
func TestChunk_DefaultChunkConfig_Ugly(t *core.T) {
	cfg := DefaultChunkConfig()
	cfg.Size = -1
...
func TestChunk_FileExtensions_Bad(t *core.T) {
	extensions := FileExtensions()
...
func TestChunk_FileExtensions_Ugly(t *core.T) {
	extensions := FileExtensions()
...
func TestChunk_ShouldProcess_Good(t *core.T) {
...
func TestChunk_ShouldProcess_Bad(t *core.T) {
...
func TestChunk_ShouldProcess_Ugly(t *core.T) {
